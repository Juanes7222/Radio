...
// "registerHeadlessTask called multiple times for same key 'TrackPlayer'".
declare global {
  var __trackPlayerRegistered: boolean | undefined;
}
if (!globalThis.__trackPlayerRegistered) {
  try {
    TrackPlayer.registerPlaybackService(() => PlaybackService);
    globalThis.__trackPlayerRegistered = true;
  } catch (e) {
