...
const mStyles = StyleSheet.create({
  ...
  dialText: { color: '#fff', fontSize: 9, letterSpacing: 0.6 },
  dialTick: { width: 1, height: 8, backgroundColor: 'rgba(255,255,255,0.2)' },
  dialNeedle: { width: 1, height: 12, backgroundColor: '#f59e0b', marginHorizontal: 2 },
  dialFm: { color: '#fff', fontSize: 8, fontWeight: '700', marginLeft: 2 },
  closeBtnDark: {
    width: 28,
    height: 28,
    borderRadius: 14,
  ...
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: 'rgba(26,28,30,0.15)' },
  eyebrowDark: {
    marginLeft: 'auto',
    fontSize: 9,
    fontWeight: '600',
  ...
  secondaryDarkText: { fontSize: 14, fontWeight: '500', color: 'rgba(26,28,30,0.7)' },
  counter: {
    marginTop: 10,
    fontSize: 11,
